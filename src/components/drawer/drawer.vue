<template>
  <div class="icui-drawer-layout">
    <div class="icui-drawer-wrap" :class="animateStyle" :style="drawerStyle">
      <slot name="drawer"/>
    </div>

    <div class="icui-drawer-content" :class="contentDrawable?animateStyle:{}"
         :style="contentDrawable?contentStyle:{}">
      <div class="icui-drawer-mask" @click="handleMaskClick" :style="{'opacity':backdropOpacity}"
...
<style scoped lang="scss">
  .drawer-layout{position: absolute;
    top: 0;
    left: 0;
    bottom: 0;
    right: 0;
